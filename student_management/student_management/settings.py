...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'studentdb',  # Replace with your database name
        'ENFORCE_SCHEMA': False,
        'CLIENT': {
            'host': 'mongodb://myuser:passwd@localhost:27017/studentdb?authSource=admin&readPreference=primaryPreferred&ssl=false',
